  ...
  return (
    ...
    <section className={styles.sectionContainer}>
        ...
        <div className={styles.navLinkFlex}>
          ...
          <NavLink className={styles.navLinkAnterior} to='/jornada/principios/page2' >Anterior</NavLink> 
          <NavLink className={styles.navLinkProximo} to='/jornada/principios/page4' >Proximo</NavLink> 
        </div>
