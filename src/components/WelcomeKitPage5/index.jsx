...
export default function WelcomeKitPage5() {
  ...
  return (
    ...
    <div className={styles.containerFifthSectionNormal}>
      ...
      <form className={styles.form} action="">
        ...
        <label htmlFor="10">10</label>
          ...
          <label className={styles.labelComentario} htmlFor="comentario">Comentário:</label>
          <textarea placeholder="Digite aqui" name="comentario" id="comentario"></textarea>
    
        
      </form>


      <NavLink className={styles.navLink} to="/welcomekit/page5">Enviar</NavLink>
    ...
    <select className={styles.selectForm} name="options" id="options" form="options">
        <option value="Digite aqui" placeholder="Digite aqui">Digite aqui</option>
    ...
    <label className={styles.comentarioResponsivoLabel} htmlFor="comentarioResponsive">Comentário</label>
    <input className={styles.comentarioResponsivoInput} type="text" placeholder="Digite aqui" />
