    ...
    <div className="profile-container">
      ...
      <div className="profile-right">
        <div className="card">
          ...
          <p>
            <strong>Data de Nascimento:</strong> 01/01/1990
          </p>
          <p>
        ...
        <div className="card">
          ...
          <p>
            <strong>Cargo:</strong> Desenvolvedor
          </p>
          <p>
            <strong>Email Corporativo:</strong> exemplo@empresa.com
          </p>
          <p>
            <strong>ID Empresa:</strong> EMP12345
          </p>
          <p>
            <strong>Tempo de Contrato:</strong> 2 anos
          </p>
        </div>
      </div>
    </div>
