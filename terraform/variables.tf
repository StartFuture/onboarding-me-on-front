...
variable "tags" {
  ...
  default = {
    "Owner" : "Start Future",
    "Website" : "onboarding-on.startfuture.com.br",
    "Project" : "Onboarding ON",
    "Team" : "Turma 3"
  }
}
...
variable "aliases_cf" {
  ...
  type        = list(string)
  default     = ["onboarding-on.startfuture.com.br"]
}
